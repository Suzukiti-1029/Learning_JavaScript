function 記号表現に変換する(カード) {
  const マーク名_絵文字 = { 'ハート': '♡', 'クローバー': '♧', 'ダイヤ': '♢', 'スペード': '♤' };
...
for (let マーク of ['ハート', 'クローバー', 'ダイヤ', 'スペード'])
  for (let 数字 = 1; 数字 <= 13; 数字++)
    カードの束.push({ マーク, 数字});
console.log(カードの束.map(記号表現に変換する));
...
選択されたカード_記号表現
  = カードの束.filter(カード => カード.マーク === 'ダイヤ').map(記号表現に変換する);
console.log(選択されたカード_記号表現);
...
選択されたカード_記号表現
  = カードの束.filter(カード => カード.数字 > 10 && カード.マーク === 'ハート').map(記号表現に変換する);
console.log(選択されたカード_記号表現);
